  ...
  describe Elasticrepo::Extractor do
    ...
    context "GET /users/:user/starred" do
      describe "#extract" do 
        ...
        context "check the extraction" do
          it "is an arry of hashes" do
            ...
            print "fixture.class: #{fixture.class}"
            print "live_extracted.repos.class: #{live_extracted.repos.class}"

            print "fixture[0]: #{fixture[0]}"
            print "live_extracted.repos[0]: #{live_extracted.repos[0]}"
            
            live_extracted.repos.to_json.should eq fixture.to_json
          end
        end
